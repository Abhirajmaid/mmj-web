...
const Policies = () => {
  return (
    <div className="md:w-[60%] w-full px-4 mx-auto md:mt-[180px] mt-[50px] md:mb-[80px] mb-[140px] text-justify ">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to MMJ, Main Road, Rahuri, Ahemadnagar,
            413705.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Mukund Maid Jewellers, accessible
            from{" "}
            <a
              href="mmjewellers.com"
      ...
      <ul>
        <li>
          <p>By email: contact@mmjewellers.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://mmjewellers.com/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://mmjewellers.com/contact-us
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: 7385302967</p>
        </li>
      </ul>
    </div>
  );
