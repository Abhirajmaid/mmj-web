...
export interface ApiJewelleryJewellery extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<
      ...
      'api::category.category'
    >;
    product_type: Attribute.Enumeration<
      [
        'rings',
        'earrings',
        'pendants',
...
export interface ApiMetalRateMetalRate extends Schema.CollectionType {
